$(document).ready(function () {
    ...
    $("#signup_show_hide_confirm_password i").on("click", function (event) {
        ...
        if (
            ...
            $("#signup_show_hide_confirm_password input").attr(
                "type",
                "password"
            );
            ...
            $("#signup_show_hide_confirm_password input").attr("type") ==
            "password"
        ) {
            $("#signup_show_hide_confirm_password input").attr("type", "text");
            $("#signup_show_hide_confirm_password i").removeClass(
                "fa-eye-slash"
            );
    ...
    // Validation sign up
    $(".signup__for").length > 0 && $('.signup__form').parsley();

    // Validation sign up
    $(".signin__for").length > 0 && $('.signin__form').parsley();
